...
legend("bottomright",legend=c("BORA1","BORA2","BORA3","Lattimore (opt. init)","Lattimore (rand. init)"),lwd=2,
...
legend( "bottomright", legend=c("BORA_1","BORA_2","BORA_3","Lattimore (opt. init)", "Lattimore (rand. init)"), lwd=3, 
        col=c("blue","green2","red","purple","black"), cex=1.5 )
